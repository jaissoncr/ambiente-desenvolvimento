    ...
    module.exports = function(grunt) {
        ...
        grunt.initConfig({
            ...
            clean: {
                ...
                all: ['readme.md', '.tmp', '.DS_Store', '.sass-cache', 'client/vendor', 'documentation/jade', 'documentation/config.codekit', 'landing/jade', 'landing/config.codekit', 'node_modules', '.git'],
                server: '.tmp'
            },
            jshint: {
                options: {
            ...
            usemin: {
                html: ['<%= yeoman.dist %>/**/*.html', '!<%= yeoman.dist %>/vendor/**'],
                    ...
                    files: [
                        {
                            ...
                            src: [
                                ...
                                'vendor/weather-icons/css/*',
                                'vendor/weather-icons/font/*',
                                'vendor/weather-icons/fonts/*',
                                'fonts/**/*',
                                'i18n/**/*',
                                'images/**/*',
                                'styles/fonts/**/*',
